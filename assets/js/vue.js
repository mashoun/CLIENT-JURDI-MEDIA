const app = Vue.createApp({
  data() {
    return {
      ...
      spinner: false,
      profile: '',
      api: 'https://script.google.com/macros/s/AKfycbzAooVXXBq0rO1FOrRPwYGLtUHRdYLS6dk0eqS7qcdGYNrSX_JUKPy0jg2-tMhSrL_QCQ/exec',
  ...
  methods: {
    ...
    dotmark(data, id) {
      ...
      document.getElementById(id).innerHTML = `<article>${parentTag.innerHTML}</article>`
      // return parentTag
      return `<article>${parentTag.innerHTML}</article>`;
    },
    href(path) {
      sessionStorage.setItem('currentService', path)
  ...
  mounted() {
    ...
    fetch(api).then(res => res.json()).then(res => {
      ...
      sessionStorage.setItem('currentService', 'Business Affairs')
    }).catch(e => {
    ...
    <header class="pop  d-flex justify-content-between align-items-center shadow p-4">
      ...
      <div class="offcanvas-body">
          ...
          <div class="ls-2 text-center d-flex justify-content-evenly align-items-center gap-3 flex-column">
              <a href="/Terms.html" class="w-100 shadow-sm p-2 text-dark-x"><strong>Terms of Use</strong></a>
              <a href="/PrivacyPolicy.html" class="w-100 shadow-sm p-2 text-dark-x"><strong>Privacy Policy</strong></a>
              <a href="#contact" class="w-100 shadow-sm p-2 text-dark-x text-dark-x"><strong>Contact Us</strong></a>
              <a :href="linked" class="w-100 shadow-sm p-2  text-dark-x"><strong>LinkedIn</strong></a>
...
app.component('hero', {
  template:
    ...
    <section class="container mt-5">
        <h1 class="cin fs-4 text-dark-x px-2 text-justify py-2 hero-text" data-aos="zoom-in-up" data-aos-duration="1000">
          <strong>{{heading}}</strong>
        </h1>
        <p class="text-second-x fs-5 px-2 pop text-justify text-center"  data-aos="fade-in" data-aos-duration="1000" data-aos-delay="100">
        {{bio}}
        </p>
    </section>
    `,
...
app.component('card', {
  template:
    /*html */
    `
    <section class="shadow card-section" >
        <img :src="src" :alt="text" class="w-100 h-100 cover img-grey">
      ...
      <div class="col-lg-6 col-12 my-4" >
        <div class="row justify-content-center gap-3 mb-3">
          ...
          <div data-aos="zoom-in-up" data-aos-duration="1000" data-aos-delay="100" class="pop p-4 shadow-sm col-12 col-md-5 d-flex flex-column gap-1 rounded">
              ...
              <a :href="'tel:'+profile.number" class="fs-6 text-second-x  text-justify"> + {{profile.number}} </a>
          ...
          <div data-aos="zoom-in-up" data-aos-duration="1000" data-aos-delay="300" class="pop p-4 shadow-sm col-12 col-md-5 d-flex flex-column gap-1 rounded">
              ...
              <a :href="'mailto:'+profile.email" class="fs-6 text-second-x  text-justify"> {{profile.email}} </a>
        ...
        <div class="row justify-content-center gap-3">
          ...
          <div data-aos="zoom-in-up" data-aos-duration="1000" data-aos-delay="500" class="pop p-4 shadow-sm col-12 col-md-5 d-flex flex-column gap-1 rounded">
              ...
              <p class="fs-6 text-second-x  text-justify"> {{profile.address}} </p>
              <!-- <button class="w-100 btn btn-success"> <i class="bi bi-whatsapp"></i> Whatsapp</button> -->
          </div>
          <!-- Email Us -->
          <div data-aos="zoom-in-up" data-aos-duration="1000" data-aos-delay="700" class="pop p-4 shadow-sm col-12 col-md-5 d-flex flex-column gap-1 rounded">
              ...
              <p href="" class="fs-6 text-second-x  text-justify">
  ...
  template:
    ...
    <section>
      ...
      <h6
        ...
        ondblclick="alert('Developed by lebancode.com / Version 1.0.0')"
      >
        All Rights Reserved
      </h6>
